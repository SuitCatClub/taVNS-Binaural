...
| Current source topology | Howland current pump | **V-to-I converter (ADA4522-2ARZ)** | Research resolved: V-to-I is more stable into varying electrode impedance |
| Voltage reference | (missing) | **MCP1501-10E/SN** | MCP4922 DAC has no internal Vref — needs external. MCP1501-10: 1.024V, 0.08%, 10ppm/C, SOIC-8. With 2x gain: Imax=10.24mA, 2.5uA/LSB. Source: DigiKey/Mouser |
| H-Bridge | A4950ELJTR-T (40V) | **DRV8837DSGR** | DRV8871DDAR has 6.5V min VM — incompatible with V-to-I topology where VM = op-amp output (can be as low as 0.3V). Discrete BSS84+BSS138 also fails: P-channel gate can't be turned off by 5V logic when source > 6V. DRV8837: 0–11V VM, SOT-23-6, built-in dead-time. Compliance capped at ~10V (Z_max at 5mA = 2kΩ, at 2mA = 5kΩ — adequate). Source: DigiKey/Mouser |
